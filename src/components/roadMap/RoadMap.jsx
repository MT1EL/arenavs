...
function RoadMap() {
  let firstHalfIcon = { background: "#c45260" };
  let secondHalfIcon = {
  ...
  return (
    <section className="Roadmap">
      ...
      <p className="roadMapHeader">The main milestones of the Project</p>
      <VerticalTimeline lineColor="#c45260">
        {data.map((item) => {
          let isFirstHalf = item.icon === "firstHalfIcon";

          return (
            <VerticalTimelineElement
              key={item.id}
              iconStyle={isFirstHalf ? firstHalfIcon : secondHalfIcon}
              icon={"0" + item.id}
              iconClassName="icon"
              className="elem"
            ...
            >
              <div className="components">
                {item.checkTexts !== false ? (
                  <div className="wholeLis">
                    {item.checkTexts.map((text) => {
                      return (
                        <div className="checkLis">
                          <img src={item.checksrc} alt="checkedIcon" />
                          <h3 className="roadMapH3">{text}</h3>
                        </div>
                      );
                    })}
                    {item.uncheckTexts.map((text) => {
                      return (
                        <div className="checkLis">
                          <img src={item.unchecksrc} alt="uncheckIcon" />
                          <h3 className="roadMapH3">{text}</h3>
                        </div>
                      );
                    })}
