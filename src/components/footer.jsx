    ...
    <section>
      <div className="relativeContainer">
        ...
        <div className="container">
          <h1 className="footerH">GET IN TOUCH</h1>
      ...
      <div className="footerOffooter">
        <div className="footerIcons">
          ...
          <div className="icons">
            <div className="icon">
              <a href="https://www.reddit.com/user/ArenaMasterToken/">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
            ...
            <div className="icon">
              <a href="https://t.me/ArenaMasters">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
            ...
            <div className="icon">
              <a href="https://twitter.com/arenamastergame">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
            ...
            <div className="icon">
              <a href="https://medium.com/@ArenaMasterGame">
                <svg
                  stroke="currentColor"
                  fill="currentColor"
                  stroke-width="0"
        ...
        <div className="newsLetter">
          ...
          <div className="inputAbutton">
            <input type="email" placeholder="Enter Your Email" />
            <button>Subscribe</button>
          </div>
        </div>
        <div>
          <p className="copyRightTHing">© 2022 Arena. All rights reserved.</p>
        </div>
      </div>
    </section>
  );
